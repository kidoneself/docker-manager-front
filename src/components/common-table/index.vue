...
const CONTRACT_STATUS_OPTIONS = [
  { value: CONTRACT_STATUS.FAIL, label: '失败' },
  { value: CONTRACT_STATUS.AUDIT_PENDING, label: '审核中' },
  { value: CONTRACT_STATUS.EXEC_PENDING, label: '待执行' },
  { value: CONTRACT_STATUS.EXECUTING, label: '执行中' },
